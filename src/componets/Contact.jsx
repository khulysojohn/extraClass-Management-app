  ...
  return (
    <div name='contact' className='w-full h-screen bg-[#1E2D40] flex justify-center items-center pt-8'>
      ...
      <form method='POST' action="" className='flex flex-col max-w-[600px] w-full'>
        ...
        <button className='text-white border-2 hover:bg-[#00FFC3] hover:text-black hover:border-[#00FFC3] px-4 py-3 my-8 mx-auto flex items-center'>Let's Collaborate</button>
      </form>
